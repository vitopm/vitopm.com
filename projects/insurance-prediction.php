            ...
            <div class="project-website-list">
                <a href="https://vitopm-insurance-charge-prediction-app-2kzdfm.streamlitapp.com/" target="_blank"> 
                    <div class="website-desc">
                        <h2>Insurance Charge Website</h2>
                        <p>
                            Click here to try the predicting app.
                        </p>
                    </div>
                </a>
                ...
                <a href="machine-learning.html" target="_blank"> 
                    <div class="website-desc">
                        <h2>Insurance Charge Jupyter Notebook</h2>
                        <p>
                            Click here to see the data analytics, preprocessing, machine learning model training and testing.
                        </p>
                    </div>
                </a>
            </div>
